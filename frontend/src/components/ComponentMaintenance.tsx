...
const Maintenance: React.FC = () => {
  return (
    <div className="max-w-full select-none h-full dark:bg-gray-900">
      <div className="max-w-6xl flex-grow container px-4 py-12 mx-auto p-5">
        <div className="text-center p-4 dark:text-white">
          ...
          <p className="text-lg">This component is currently undergoing maintenance. Please check back later.</p>
        </div>
      </div>
    </div>
  );
