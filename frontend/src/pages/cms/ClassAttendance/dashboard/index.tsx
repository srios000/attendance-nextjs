    ...
    return (
        <div className='flex max-w-full h-[80vh] overflow-y-scroll dark:bg-gray-900 flex-col bg-gradient-to-br from-gray-50 to-gray-200 dark:from-gray-900 dark:to-gray-800'>
            <div className="max-w-7xl mx-auto p-4">
                <div className="mb-6">
                    <div className="flex items-center gap-3 p-4 rounded-lg border border-blue-200 bg-blue-50 dark:bg-blue-900/20 dark:border-blue-900">
                        <i className="fa-solid fa-circle-info"></i>
                        <p className="text-sm text-blue-800 dark:text-blue-200">
                            This dashboard is currently in beta. Some features may be experimental and subject to change.
                        </p>
                    </div>
                </div>
